...
int lofar_udp_io_read_setup_ZSTD(lofar_udp_reader_input *input, const lofar_udp_config *config, const lofar_udp_meta *meta, int port);
int lofar_udp_io_read_setup_DADA(lofar_udp_reader_input *input, const lofar_udp_config *config, const lofar_udp_meta *meta, int port);
...
int lofar_udp_io_fread_temp(const lofar_udp_config *config, int port, void *outbuf, size_t size, int num, int resetSeek);
